          ...
          text: JSON.stringify(
            {
              ...
              diagramFlow: "generate_diagram renders an architecture/flow ponchi-e as one clean SVG (immune to PowerPoint re-layout): connectors clip to node borders with real arrowheads, nodes carry kind-based icons (actor/system/process/data/note/cloud) and accent bars, and groups render as lanes. Use arrow.style 'orthogonal' for elbow routing, arrow.bidirectional for two-way links, and node.sublabel/emphasis for hierarchy. Prefer this over hand-built arrow shapes for every conceptual diagram.",
