          ...
          text: JSON.stringify(
            {
              ...
              layoutGuardrails: "render_pptx always applies layout polish and reading-order normalization before drawing. Remaining layout.text-overflow-risk is an error: shorten copy, split the slide, or choose a schematic/table/list layout instead of forcing a broken PPTX.",
              cognitiveLoad: "Use one visual grammar per slide. Prefer table for comparisons, tree for hierarchy, flow/vertical-flow for processes, and list/list-horizontal for 3-4 key points. Avoid many custom text boxes with uneven manual line breaks.",
