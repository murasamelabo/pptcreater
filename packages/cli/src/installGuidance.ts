...
- Blocking layout rules: \`layout.text-overflow-risk\`, \`layout.text-overlap\`, \`layout.bad-line-break\`, and \`visual.svg-text-too-small\` must be fixed before final PPTX delivery. Treat \`layout.enumeration-hierarchy\` as a strong design warning.
