...
export const BUILTIN_SKILL_PACKS: SkillPack[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      "Slidelandのcool/minimal/trust系事例を見本に、表現力・フォント階層・配置・間隔・余白・配色の近さを評価する。coolは高コントラストと大胆なトリミング/余白、minimalは削ぎ落とした要素数と明快なグリッド、trustは落ち着いた色・安定した表/グラフ・読みやすい余白を重視する",
  ...
  },
  {
    ...
    rules: [
      ...
      "Use Slideland-style cool/minimal/trust references as a taste benchmark for expression quality, typography hierarchy, placement, spacing, whitespace, and color discipline. Cool uses high contrast and bold cropping/whitespace; minimal reduces elements and colors; trust uses calm palettes, stable tables/charts, and readable whitespace",
